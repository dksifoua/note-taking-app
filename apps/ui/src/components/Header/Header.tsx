...
export function Header(): JSX.Element {
    ...
    return (
        <div>
            <div
                className="lg:hidden h-13 md:h-18 flex flex-row gap-x-4 px-4 md:px-8 py-3 md:py-4 items-center bg-neutral-100">
                <Logo/>
            </div>
            <div
                className="max-lg:hidden h-20 flex flex-row px-8 items-center justify-between border-b border-b-neutral-200">
