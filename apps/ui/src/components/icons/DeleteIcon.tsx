...
export function DeleteIcon({ className }: { className?: string }): JSX.Element {
    ...
    return (
        <svg className={className} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                stroke="#0E121B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10.1992 12.8164V17.3248M13.5796 12.8164V17.3248" stroke="#0E121B" strokeWidth="1.5"
